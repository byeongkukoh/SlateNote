다음과 같은 명령을 사용하여 [티도리 프레임워크 템플릿](https://github.com/pronist/tidory/tree/master/packages/template)을 받아온 뒤, 프로젝트 구동을 위한 **NPM** 패키지들을 설치하십시오.

```bash
npx degit https://github.com/pronist/tidory/packages/template tistory-skin
cd tistory-skin
```
...
>[설정](https://github.com/pronist/tidory/wiki/Configuration)에서 `ts_session`, `url`, `mode` 가 설정되어 있어야 합니다.
